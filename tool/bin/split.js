...
Extractor.prototype = {
	...
	,linkOrphans: function() {
		...
		var _g1 = 0;
		var _g2 = ["$estr","$hxClasses","$hxEnums","Std","HxOverrides"];
...
MinifyId.blacklist = (function($this) {
	var $r;
	var t = null;
	var _g = new haxe_ds_StringMap();
	if(__map_reserved["HxOverrides"] != null) {
		_g.setReserved("HxOverrides",true);
	} else {
		_g.h["HxOverrides"] = true;
	}
	$r = _g;
	return $r;
}(this));
